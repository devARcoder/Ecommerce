...
const LimitedOffer = () => {
  return (
    ...
    <div className="relative bg-blue-400 text-white mx-9 md:mx-10 rounded-xl md:rounded-l-lg mt-16 md:px-8 flex flex-col md:flex-row items-center justify-center md:justify-between">
      ...
      <p className="text-lg sm:text-xl font-bold">Limited Time Offer</p>
        ...
        <div className="btns flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4 font-semibold w-full px-2">
          <button className="bg-white text-black rounded-md md:rounded-l-md py-3 px-5 sm:py-3 md:py-2 hover:bg-black hover:text-white w-full md:w-auto">
            SHOP NOW
          </button>
      ...
      {/* Image */}
      <img
        className="absolute md:relative w-full md:w-1/2 h-full object-cover md:object-contain md:top-8 left-0 md:left-auto md:right-0 opacity-15 md:opacity-100 md:h-[70vh]"
        src={offerBanner}
        alt="Offer Banner"
      />
    </div>
