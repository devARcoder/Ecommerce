    ...
    <>
      <div className="px-3 py-3 flex flex-col justify-center items-start">
        ...
        <div className="flex flex-col space-y-2 mt-2">
          ...
          <span className="absolute -mt-10 ml-24 rotate-12 sm:-mt-6 sm:ml-36 sm:rotate-0 md:-mt-6 md:ml-40 md:rotate-0 text-[7px] font-semibold font-serif bg-green-500 text-white w-14 px-1 py-1 rounded-full">
            AR Products
          </span>
          </div>
