  ...
  return (
        ...
        <div className="flex flex-col space-y-2">
          ...
          <di className="flex flex-col px-2 py-1 md:space-y-6">
            ...
            <div className="1 flex items-center space-x-2 py-1">
              ...
              <div className="flex flex-col items-start">
                <h3 className='font-bold text-sm'>ARS Yellow Shoes</h3>
                <div className="flex">
                <span className="text-1xl text-yellow-500">&#9733;</span>
                <span className="text-1xl text-yellow-500">&#9733;</span>
                <span className="text-1xl text-yellow-500">&#9733;</span>
    ...
    <ol className="flex items-center whitespace-nowrap my-6 mx-4">
          ...
          <div className="text-center mx-10 space-y-4 md:mx-20">
            <h1 className='text-2xl md:text-5xl '>Women</h1>
      ...
      <div className="grid grid-cols-2 md:grid md:grid-cols-3 gap-2 px-4 mt-6">
